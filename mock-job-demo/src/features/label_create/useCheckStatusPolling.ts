...
import type { CheckStatusRequest, Phase } from '../../types/createLabel';
...
export function useCheckStatusPolling(params: { operationId: string | null; phase: Phase; epic: string | null; operation: string | null }): void {
